...
public partial class clientSplitInquire : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        reqHandler.setParameter("sp_billno", "1755569220");				//商家订单号
        reqHandler.setParameter("transaction_id", "1900000107201006081755569220");	//财付通交易单号
        ...
        httpClient.setCertInfo("c:/1900000107.pfx", "1900000107");
        ...
        if (httpClient.call())
        {
            ...
            if (resHandler.isTenpaySign() && resHandler.getParameter("pay_result") == "0")
            {
                ...
                Response.Write("pay_time=" + resHandler.getParameter("pay_time") + "<br>");
                Response.Write("bus_type=" + resHandler.getParameter("bus_type") + "<br>");
                Response.Write("bus_args=" + resHandler.getParameter("bus_args") + "<br>");
                Response.Write("bus_split_refund_args=" + resHandler.getParameter("bus_split_refund_args") + "<br>");
                Response.Write("bus_platform_refund_args=" + resHandler.getParameter("bus_platform_refund_args") + "<br>");
                Response.Write("bus_freeze_args=" + resHandler.getParameter("bus_freeze_args") + "<br>");
                Response.Write("bus_thaw_args=" + resHandler.getParameter("bus_thaw_args") + "<br>");
