...
public partial class clientFreeze : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        reqHandler.setGateUrl("https://mch.tenpay.com/cgi-bin/split_freeze.cgi");

        reqHandler.setParameter("cmdno", "97");
        reqHandler.setParameter("version", "4");
        reqHandler.setParameter("fee_type", "1");
        reqHandler.setParameter("bargainor_id", bargainor_id);		//商户号
        reqHandler.setParameter("sp_billno", "1113061747");				//商家订单号
        reqHandler.setParameter("transaction_id", "1900000107201006291113061747");	//财付通交易单号
        ...
        reqHandler.setParameter("refund_id", "1091900000107201006290000110");
