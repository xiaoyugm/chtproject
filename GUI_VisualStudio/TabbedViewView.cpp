...
void CTabbedViewView::OnInitialUpdate() 
{
	...
	CMainFrame* pFWnd=(CMainFrame*)AfxGetMainWnd();
   	pFWnd->m_pTabbedViewView=this;

	CFrameWnd   *pFrame=this->GetParentFrame(); 
    if(pFrame)  
	{  
		pFrame->SetWindowPos(NULL,0,300,GetSystemMetrics(SM_CXSCREEN)-8,140,SWP_NOMOVE|SWP_NOZORDER | SWP_NOACTIVATE|SWP_SHOWWINDOW);
	}   
}
...
//	m_wndTabControl.GetImageManager()->SetIcons(IDI_ICON7, NULL, 0, CSize(16, 16), xtpImageNormal);
