...
//	}
	...
	strappPath += "\\Image\\Splash.bmp";
	 
	n_load = m_pSplashWnd->m_bitmap.Attach( (HBITMAP)::LoadImage(NULL, strappPath, IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE));
	if (n_load == 0)
		return FALSE;
	...
	m_pSplashWnd->SetTimer(121, uTimeOut, NULL);
