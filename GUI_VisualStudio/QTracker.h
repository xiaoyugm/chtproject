...
//
//===============================
// Version 1.1, October 2, 2003
// Added: discard small mouse messages to avoid pseudo-drag (using sysmetrics SM_CxDRAG)
//
...
public:
	enum TrackResult
	{
		TrackFailed = -2,
		TrackCancelled = -1,
		TrackCanceled = -1,		// Correction of a stupid spelling error
		TrackContinue = 0,
		TrackSucceeded = 1,
		TrackCopy = 2,
		TrackNoMove = 3
