...
String  payee=request.getParameter("Payee");
	...
	String orig;		//原始数据
	orig = "masterid=2000000833|orderid="+orderid+"|currency=RMB|amount="+(count*price)+"|timestamp="+timestamp+"|validtime=0|remark=sdb";
...
<!--
	 <form  NAME= "PayForm" ACTION="https://ebank.sdb.com.cn/corporbank/merpayb2b.do"  METHOD=POST>
-->
 <form  NAME= "PayForm" ACTION="https://testebank.sdb.com.cn/corporbank/merpayb2b.d"  METHOD=POST>
...
<P><FONT COLOR= "#003399 " FACE= "宋体 ">数量：</FONT></TD>
		...
		<TD COLSPAN=2 HEIGHT=16><P>
                      <INPUT TYPE=SUBMIT NAME= "Paygate" VALUE= "深圳发展银行支付网关" onClick="PayForm.action='https://testebank.sdb.com.cn/corporbank/merpayb2b.do';">
                </TD> 
 		</TR>
 		</TABLE>
 		</TD>
		...
		<input type=hidden name=orig value="<%=orig%>" >
    	        <input type=hidden name="transName" value="EntPaygate" >
<!--返回url地址：商户根据自己系统情况设定-->
         <input type='hidden' name='returnurl' value='http://10.1.9.160:8080/b2b_merchant/receivedemo.jsp'>
         <input type='hidden' name='NOTIFYURL' value='http://10.1.9.160:8080/b2b_merchant/receivedemo.jsp'>
                  <br>
         <br>
         <br>
         <br><br><br>
