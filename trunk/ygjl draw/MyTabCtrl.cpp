...
void CMyTabCtrl::AddTab(CWnd* pWnd, LPTSTR lpszCaption, int iImage)
{
	ASSERT_VALID(pWnd);
...
void CMyTabCtrl::EnableTab(int iIndex, BOOL bEnable)
{
...
BOOL CMyTabCtrl::IsTabEnabled(int iIndex)
{
	ASSERT(iIndex < m_arrayStatusTab.GetSize());
